...
class TORCH_API MaxUnpool1dImpl : public MaxUnpoolImpl<1, MaxUnpool1dImpl> {
 public:
  ...
  Tensor forward(
    ...
    const c10::Optional<ExpandingArray<1>>& output_size = c10::nullopt);
};
...
class TORCH_API MaxUnpool2dImpl : public MaxUnpoolImpl<2, MaxUnpool2dImpl> {
 public:
  ...
  Tensor forward(
    const Tensor& input,
    const Tensor& indices,
    const c10::Optional<ExpandingArray<2>>& output_size = c10::nullopt);
};
...
class TORCH_API MaxUnpool3dImpl : public MaxUnpoolImpl<3, MaxUnpool3dImpl> {
 public:
  ...
  Tensor forward(
    const Tensor& input,
    const Tensor& indices,
    const c10::Optional<ExpandingArray<3>>& output_size = c10::nullopt);
};
