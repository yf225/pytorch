...
class TritonScheduling(SIMDScheduling):
    ...
    def _emit_kernel_to_wrapper(
        self, wrapper, kernel, src_code, kernel_name, subs_name,
        ...
        if template_buffer is not None and template_buffer.emit_kernel(
            wrapper, src_code, kernel_name, node_schedule, kernel_path, get_kernel_metadata
        ):
            return  # Helion handled it
    ...
    def define_kernel(self, src_code, node_schedule, kernel):
        ...
        if src_code in wrapper.src_to_kernel:
            ...
            self._emit_kernel_to_wrapper(
                wrapper, kernel, src_code, kernel_name, subs_name,
                node_schedule, kernel_path, get_kernel_metadata
            )
