...
class TemplateBuffer(OperationBuffer):
    ...
    def __init__(
        ...
        named_inputs: Optional[dict[str, "IRNode"]] = None,
    ) -> None:
        ...
        self._named_inputs: dict[str, "IRNode"] = dict(named_inputs) if named_inputs else {}
        ...
        self.allowed_prologue_inps: OrderedSet[str] = allowed_prologue_inps or OrderedSet()
    ...
    def extract_read_writes(self, normalize: bool = False) -> dependencies.ReadWrites:
        ...
        if isinstance(self.layout, MultiOutputLayout):
            ...
            return dependencies.ReadWrites(
                ...
                writes=writes, index_exprs=OrderedSet(),
    ...
    def fuse(self, spec: "TemplateFusionSpec") -> "TemplateFusionOutput":
        ...
        Called by ``ExternalTritonTemplateKernel.codegen_template_override``
