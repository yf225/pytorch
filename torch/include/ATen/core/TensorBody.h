...
class TORCH_API Tensor: public TensorBase {
 ...
 public:
  ...
  int64_t __dispatch_numel() const;
  int64_t __dispatch_dim() const;
  int64_t __dispatch_get_device() const;
  int64_t __dispatch_storage_offset() const;
  bool __dispatch_is_contiguous() const;
  bool __dispatch_is_contiguous(at::MemoryFormat memory_format) const;
  ...
  at::Tensor & _philox_normal_(const at::Tensor & key, double mean=0, double std=1) const;
  at::Tensor & _philox_uniform_(const at::Tensor & key, double low=0, double high=1) const;
...
inline int64_t Tensor::__dispatch_numel() const {
    return at::_ops::numel::call(const_cast<Tensor&>(*this));
}

// aten::dim(Tensor self) -> int
inline int64_t Tensor::__dispatch_dim() const {
    return at::_ops::dim::call(const_cast<Tensor&>(*this));
}

// aten::get_device(Tensor self) -> int
inline int64_t Tensor::__dispatch_get_device() const {
    return at::_ops::get_device::call(const_cast<Tensor&>(*this));
}

// aten::storage_offset(Tensor self) -> int
inline int64_t Tensor::__dispatch_storage_offset() const {
    return at::_ops::storage_offset::call(const_cast<Tensor&>(*this));
}

// aten::is_contiguous(Tensor self) -> bool
inline bool Tensor::__dispatch_is_contiguous() const {
    return at::_ops::is_contiguous::call(const_cast<Tensor&>(*this));
}

// aten::is_contiguous.memory_format(Tensor self, MemoryFormat memory_format) -> bool
inline bool Tensor::__dispatch_is_contiguous(at::MemoryFormat memory_format) const {
    return at::_ops::is_contiguous_memory_format::call(const_cast<Tensor&>(*this), memory_format);
}
...
inline at::Tensor & Tensor::_philox_normal_(const at::Tensor & key, double mean, double std) const {
    return at::_ops::_philox_normal_::call(const_cast<Tensor&>(*this), key, mean, std);
}

// aten::_philox_uniform_(Tensor(a!) self, Tensor key, float low=0, float high=1) -> Tensor(a!)
inline at::Tensor & Tensor::_philox_uniform_(const at::Tensor & key, double low, double high) const {
    return at::_ops::_philox_uniform_::call(const_cast<Tensor&>(*this), key, low, high);
}
