...
_(aten, _flash_attention_forward_no_dropout_inplace) \
_(aten, _foobar) \
_(aten, _foreach_abs) \
...
_(aten, _philox_key_fold_in) \
_(aten, _philox_key_split) \
_(aten, _philox_normal) \
_(aten, _philox_normal_) \
_(aten, _philox_uniform) \
_(aten, _philox_uniform_) \
_(aten, _pin_memory) \
...
_(aten, _upsample_lanczos2d_aa) \
_(aten, _upsample_lanczos2d_aa_backward) \
