...
annotated_args = {
    ...
    torch._C._VariableFunctions._philox_key_split: [{'is_kwarg_only': 'False', 'name': 'key', 'simple_type': 'Tensor'}, {'is_kwarg_only': 'False', 'name': 'num_splits', 'simple_type': 'int64_t'}],
    torch._C._VariableFunctions._philox_key_fold_in: [{'is_kwarg_only': 'False', 'name': 'key', 'simple_type': 'Tensor'}, {'is_kwarg_only': 'False', 'name': 'data', 'simple_type': 'int64_t'}],
    torch._C._VariableFunctions._philox_normal_: [{'is_kwarg_only': 'False', 'name': 'self', 'simple_type': 'Tensor'}, {'is_kwarg_only': 'False', 'name': 'key', 'simple_type': 'Tensor'}],
    torch._C._VariableFunctions._philox_uniform_: [{'is_kwarg_only': 'False', 'name': 'self', 'simple_type': 'Tensor'}, {'is_kwarg_only': 'False', 'name': 'key', 'simple_type': 'Tensor'}],
    ...
    torch._C._VariableFunctions._foreach_clone: [{'is_kwarg_only': 'False', 'name': 'self', 'simple_type': 'TensorList'}],
    ...
    torch._C._VariableFunctions._flash_attention_forward_no_dropout_inplace: [{'is_kwarg_only': 'False', 'name': 'out', 'simple_type': 'Tensor'}, {'is_kwarg_only': 'False', 'name': 'query', 'simple_type': 'Tensor'}, {'is_kwarg_only': 'False', 'name': 'key', 'simple_type': 'Tensor'}, {'is_kwarg_only': 'False', 'name': 'value', 'simple_type': 'Tensor'}, {'is_kwarg_only': 'False', 'name': 'cum_seq_q', 'simple_type': 'Tensor?'}, {'is_kwarg_only': 'False', 'name': 'cum_seq_k', 'simple_type': 'Tensor?'}, {'is_kwarg_only': 'False', 'name': 'max_q', 'simple_type': 'SymInt'}, {'is_kwarg_only': 'False', 'name': 'max_k', 'simple_type': 'SymInt'}, {'is_kwarg_only': 'False', 'name': 'dropout_p', 'simple_type': 'double'}, {'is_kwarg_only': 'False', 'name': 'is_causal', 'simple_type': 'bool'}, {'is_kwarg_only': 'False', 'name': 'return_debug_mask', 'simple_type': 'bool'}],
    ...
    torch._C._nn._upsample_bicubic2d_aa: [{'is_kwarg_only': 'False', 'name': 'self', 'simple_type': 'Tensor'}, {'is_kwarg_only': 'False', 'name': 'output_size', 'simple_type': 'SymIntArrayRef', 'size': 2}, {'is_kwarg_only': 'False', 'name': 'align_corners', 'simple_type': 'bool'}],
    torch._C._nn._upsample_lanczos2d_aa: [{'is_kwarg_only': 'False', 'name': 'input', 'simple_type': 'Tensor'}, {'is_kwarg_only': 'False', 'name': 'output_size', 'simple_type': 'SymIntArrayRef?'}, {'is_kwarg_only': 'False', 'name': 'align_corners', 'simple_type': 'bool'}, {'is_kwarg_only': 'False', 'name': 'scale_factors', 'simple_type': 'ArrayRef<double>?'}],
    torch._C._nn._upsample_lanczos2d_aa: [{'is_kwarg_only': 'False', 'name': 'self', 'simple_type': 'Tensor'}, {'is_kwarg_only': 'False', 'name': 'output_size', 'simple_type': 'SymIntArrayRef', 'size': 2}, {'is_kwarg_only': 'False', 'name': 'align_corners', 'simple_type': 'bool'}],
    torch._C._nn._upsample_lanczos2d_aa: [{'is_kwarg_only': 'False', 'name': 'self', 'simple_type': 'Tensor'}, {'is_kwarg_only': 'False', 'name': 'output_size', 'simple_type': 'SymIntArrayRef', 'size': 2}, {'is_kwarg_only': 'False', 'name': 'align_corners', 'simple_type': 'bool'}],
    ...
    torch.Tensor._philox_normal_: [{'is_kwarg_only': 'False', 'name': 'self', 'simple_type': 'Tensor'}, {'is_kwarg_only': 'False', 'name': 'key', 'simple_type': 'Tensor'}],
    torch.Tensor._philox_uniform_: [{'is_kwarg_only': 'False', 'name': 'self', 'simple_type': 'Tensor'}, {'is_kwarg_only': 'False', 'name': 'key', 'simple_type': 'Tensor'}],
