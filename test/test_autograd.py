...
method_tests = [
    ('add', (S, S, S), ((S, S, S),)),
    ('add', (S, 0, S), ((S, 0, S),), 'empty'),
    ('add', (S, S, S), ((S, S),), 'broadcast_rhs'),
    ('add', (S, 0, S), ((0, S),), 'broadcast_rhs_empty'),
    ('add', (S, S), ((S, S, S),), 'broadcast_lhs'),
    ('add', (0, S), ((S, 0, S),), 'broadcast_lhs_empty'),
    ('add', (S, 1, S), ((M, S),), 'broadcast_all'),
    ('add', (S, 1, 0), ((M, 0),), 'broadcast_all_empty'),
    ('add', (), ((),), 'scalar'),
    ('add', (S, S, S), ((),), 'scalar_broadcast_rhs'),
    ('add', (S, S, 0), ((),), 'scalar_broadcast_rhs_empty'),
    ('add', (), ((S, S, S),), 'scalar_broadcast_lhs'),
    ('add', (), ((S, S, 0),), 'scalar_broadcast_lhs_empty'),
    ('add', (S, S, S), (3.14,), 'constant'),
    ('add', (S, S, 0), (3.14,), 'constant_empty'),
    ('add', (), (3.14,), 'scalar_constant'),
    ('__radd__', (S, S, S), (3.14,), 'constant'),
    ('__radd__', (S, S, 0), (3.14,), 'constant_empty'),
    ('__radd__', (), (3.14,), 'scalar_constant'),
    ('sub', (S, S, S), ((S, S, S),)),
    ('sub', (S, 0, S), ((S, 0, S),), 'empty'),
    ('sub', (S, S, S), ((S, S),), 'broadcast_rhs'),
    ('sub', (S, 0, S), ((0, S),), 'broadcast_rhs_empty'),
    ('sub', (S, S), ((S, S, S),), 'broadcast_lhs'),
    ('sub', (0, S), ((S, 0, S),), 'broadcast_lhs_empty'),
    ('sub', (S, 1, S), ((M, S),), 'broadcast_all'),
    ('sub', (S, 1, 0), ((M, 0),), 'broadcast_all_empty'),
    ('sub', (S, S, S), ((),), 'scalar_broadcast_rhs'),
    ('sub', (S, S, 0), ((),), 'scalar_broadcast_rhs_empty'),
    ('sub', (), ((S, S, S),), 'scalar_broadcast_lhs'),
    ('sub', (), ((S, S, 0),), 'scalar_broadcast_lhs_empty'),
    ('sub', (S, S, S), (3.14,), 'constant'),
    ('sub', (S, S, 0), (3.14,), 'constant_empty'),
    ('sub', (), (3.14,), 'scalar_constant'),
    ('__rsub__', (S, S, S), (3.14,), 'constant'),
    ('__rsub__', (S, S, 0), (3.14,), 'constant_empty'),
    ('__rsub__', (), (3.14,), 'scalar_constant'),
    ('mul', (S, S, S), ((S, S, S),)),
    ('mul', (S, 0, S), ((S, 0, S),), 'empty'),
    ('mul', (), ((),), 'scalar'),
    ('mul', (S, S, S), ((S, S),), 'broadcast_rhs'),
    ('mul', (S, 0, S), ((0, S),), 'broadcast_rhs_empty'),
    ('mul', (S, S), ((S, S, S),), 'broadcast_lhs'),
    ('mul', (0, S), ((S, 0, S),), 'broadcast_lhs_empty'),
    ('mul', (S, 1, S), ((M, S),), 'broadcast_all'),
    ('mul', (S, 1, 0), ((M, 0),), 'broadcast_all_empty'),
    ('mul', (S, S, S), ((),), 'scalar_broadcast_rhs'),
    ('mul', (S, S, 0), ((),), 'scalar_broadcast_rhs_empty'),
    ('mul', (), ((S, S, S),), 'scalar_broadcast_lhs'),
    ('mul', (), ((S, S, 0),), 'scalar_broadcast_lhs_empty'),
    ('mul', (S, S, S), (3.14,), 'constant'),
    ('mul', (S, S, 0), (3.14,), 'constant_empty'),
