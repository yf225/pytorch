...
inline at::Tensor tensor(at::native::detail::ListInitTensor list_init_tensor, const at::TensorOptions& options) {
  return autograd::make_variable(at::tensor(list_init_tensor, options), options.requires_grad());
}

inline at::Tensor tensor(at::native::detail::ListInitTensor list_init_tensor) {
