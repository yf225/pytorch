...
private:
  ...
  // static at::Tensor tmp_unpack(const Tensor & t, const char * name, int pos);
  // static at::SparseTensorRef tmp_unpack(SparseTensorRef t, const char * name, int pos);
  // static at::Tensor tmp_unpack_opt(const Tensor & t, const char * name, int pos);
  // static std::vector<at::Tensor> tmp_unpack(at::TensorList tl, const char *name, int pos);
